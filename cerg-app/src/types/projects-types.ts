...
export const projects: Project[] = [
  {
    ...
    description: `This project is using a case study of energy needs in the Navajo
  ...
  },
  {
    ...
    description: `This is a review of how the Navajo water crisis is portrayed in mainstream media before and after the COVID-19 pandemic started. NVivio is a qualitative analysis program that is being used to assign the tone of the authors from differing news sources, both politically and geographically. A separate quantitative analysis will be done of articles prior to the pandemic to visualize reporting popularity. The project goal is to assess how a specific narrative is filtered down through different perspectives before it reaches the public, including potential project engineers for future Navajo water projects.`,
  ...
  },
  {
    ...
    description: `Through a collaboration with the Universidad Privada Boliviana and Fundación Ingenieros en Acción, a mobile education center was developed to provide rural Bolivians with the necessary skills to employ renewable resources, especially in an effort to mitigate the devastating impacts that climate change will have on traditional rural lifestyles. Researchers are working to hone the performance of a permanent FEW Center that will strengthen the relationship, appreciation, and information exchange between rural and urban residents.`,
    researchers: "Alex Timmons, Ann Witmer, Jessica Mingee",
    image: "/images/pouring lids1.JPG",
  },
  {
    title: "El Durazno Wind Turbine Project",
    description: `This project is prototyping and testing a wind turbine made from repurposed car parts. It aims to make a turbines capable of powering a pump for a water distribution system in El Durazno. After establishing the power generation, our goal is to continue with the design of the distribution system to provide reliable water to the community. Designs are being tested and implemented in Guatemala with collaboration from a local nonprofit.`,
    researchers:
