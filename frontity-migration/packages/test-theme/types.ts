 ...
 */
interface TestThemeTypeScript extends Package {
  /**
   * The name of this package.
   */
  name: "@frontity/test-theme-typescript";
...
export default TestThemeTypeScript;

/**
 * Packages required by `TestThemeTypeScript`.
 */
