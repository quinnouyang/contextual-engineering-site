			...
			<Container py={["2em", "3em", "4em"]}>
				<VStack p="2em" spacing="1em" bgColor="white" align="left">
					<Text variant="article">
						This project is a case study of energy needs in the Navajo Nation
						aimed at better understanding how the local social, political,
						cultural, and economic factors influence the selection of the most
